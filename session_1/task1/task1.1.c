 ...
 * balance with the purchase amount and determine if the transaction can be
 * completed.
 *
 * Input
 ...
 *
 * Output
 * - Print "Transaction Approved. Remaining balance xx.xx" if the balance is
 * greater than or equal to the purchase amount
